...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/05 16:48:21 by aduban            #+#    #+#             */
/*   Updated: 2017/05/05 16:56:06 by aduban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		init_game(t_shm *shm)
{
	...
	ft_memset(shm->m + sizeof(shm->m) - TRUEMAP_WIDTH,
			MAP_BORDERWIDTH, TRUEMAP_WIDTH - 1);
